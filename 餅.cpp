...
void Init(void)
{
	...
	LoadTexture(&rope.Tex, "紐あそび.png", 0, 0/*画像全部読み込み*/, NULL);
}
...
void Update(void)
{
	D3DXMatrixTranslation(&rope.Mat, rope.x, rope.y,1);
...
void Render2D(void)
{
	...
	lpSprite->SetTransform(&rope.Mat);
	lpSprite->Draw(rope.Tex, &rcrope, &D3DXVECTOR3(0, 0, 0), NULL, D3DCOLOR_ARGB(255,255, 255, 255));
